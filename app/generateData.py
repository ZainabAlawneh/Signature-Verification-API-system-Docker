...
PATH_ORG = r"signatures\full_org"
PATH_FORG = r"signatures\full_forg"
...
dataset.to_csv("dataset_.csv", index=False)
dataset_val.to_csv("dataset_val_.csv", index=False)